                        ...
                        <div class="col-lg-3 col-md-5 col-12">
                            ...
                            <div class="header-search-cart-area">
                                <ul>
                                    ...
                                    <li class="currency-menu"><a href="#"><span class="icon_lock_alt"></span></a>
                                        ...
                                        <ul class="currency-dropdown">
                                          ...
                                          <li><a href="#">language</a>
                                              <ul>
                                                  <li class="active"><a href="#"><img src="../assets/img/icon/en-gb.png" alt="">English</a></li>
                                                  <li><a href="#"><img src="../assets/img/icon/de-de.png" alt="">French</a></li>
                                              </ul>
                                          </li>
                                    ...
                                    <li class="mini-cart"><a href="#"><span class="icon_bag_alt"></span> <span class="cart-quantity">2</span> <span class="mini-cart-total">$300.00</span></a>
